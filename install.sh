#!/bin/bash
# Installs Fabric's IntelliJ configs into your user configs.

echo "Installing Fabric code style configs..."
...
echo "Done."
echo ""
echo "Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Fabric'."
